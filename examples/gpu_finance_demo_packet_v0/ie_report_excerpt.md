...
capacity snapshot, MIG ambiguity, and serial collateral binding. Evidence
window is as declared in each ARC example packet. No real customer asset,
operation, or proprietary data is reviewed.
...
| `gpu_probe_observation.json` | `gpu_acceptance_lambda_a10_supported` | real redacted ARC fixture |
